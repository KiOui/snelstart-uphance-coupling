...
abstract class SUCAPIClient {
	 ...
	 * @throws SUCAPIException
	 */
	protected function _internal_call(string $method, string $url, ?string $payload, array $params): array {
	 ...
	 * @throws SUCAPIException
	 */
	protected function _get(string $url, ?array $args, ?string $payload): array {
		if ( ! isset( $args) ) {
			$args = array();
		}
	 ...
	 * @throws SUCAPIException
	 */
	protected function _post(string $url, ?array $args, ?string $payload): array {
		if ( ! isset( $args) ) {
			$args = array();
		}
	 ...
	 * @throws SUCAPIException
	 */
	protected function _delete(string $url, ?array $args, ?string $payload): array {
		if ( ! isset( $args) ) {
			$args = array();
		}
	 ...
	 * @throws SUCAPIException
	 */
	protected function _put(string $url, ?array $args, ?string $payload): array {
		if ( ! isset( $args) ) {
			$args = array();
		}
