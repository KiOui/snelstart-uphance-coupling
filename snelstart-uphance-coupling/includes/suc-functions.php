...
if ( ! function_exists( 'suc_get_grootboek_choices' ) ) {
	function suc_get_grootboek_choices() {
		$grootboeken = suc_get_grootboeken();
...
if ( ! function_exists( 'suc_get_grootboeken' ) ) {
	function suc_get_grootboeken() {
		static $grootboeken;
		if ( isset( $grootboeken ) ) {
